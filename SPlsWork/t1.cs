...
namespace UserModule_T1
{
    public class UserModuleClass_T1 : SplusObject
    {
        ...
        public UserModuleClass_T1 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
